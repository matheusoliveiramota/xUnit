...
namespace SolucaoPerformance2
{
    ...
    public class Test1 : IDisposable
    {
        ...
        public Test1(BeforeAllTestClasses before)
        {
        ...
        {
            File.AppendAllText(@"C:\BeforeTestClasses.txt", "Classe de Teste 1 - Teste 1 - Pessoa: " + beforeAllTest.Pessoa.Nome + "  -  " + beforeAllTest.Pessoa.Cpf + Environment.NewLine);
        }

        [Fact]
        public void SecondTest()
        {
            File.AppendAllText(@"C:\BeforeTestClasses.txt", "Classe de Teste 1 - Teste 2 - Pessoa: " + beforeAllTest.Pessoa.Nome + "  -  " + beforeAllTest.Pessoa.Cpf + Environment.NewLine);
        }
    }
}
